...
class FetchMostViewedPropertiesSuccess extends FetchMostViewedPropertiesState implements PropertySuccessStateWireframe{
  @override
...
class FetchMostViewedPropertiesFailure extends FetchMostViewedPropertiesState implements PropertyErrorStateWireframe{
  final dynamic error;
...
class FetchMostViewedPropertiesCubit
    extends Cubit<FetchMostViewedPropertiesState> with HydratedMixin implements PropertyCubitWireframe {
  FetchMostViewedPropertiesCubit() : super(FetchMostViewedPropertiesInitial());

  final PropertyRepository _propertyRepository = PropertyRepository();

  fetch({bool? forceRefresh}) async {
