...
class FetchPromotedPropertiesSuccess extends FetchPromotedPropertiesState   implements PropertySuccessStateWireframe{
  @override
...
class FetchPromotedPropertiesFailure extends FetchPromotedPropertiesState implements PropertyErrorStateWireframe{
  final String error;
...
class FetchPromotedPropertiesCubit extends Cubit<FetchPromotedPropertiesState>
    with HydratedMixin implements PropertyCubitWireframe {
  ...
  bool hasMoreData() {
    if (state is FetchPromotedPropertiesSuccess) {
      ...
      log("TOTAL IS  ${(state as FetchPromotedPropertiesSuccess).total}");
